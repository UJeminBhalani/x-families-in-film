        ...
        <>
            ...
            <div className='white_box manage_screen'>
                <div className='title_box d-inline-flex w100p'>
                    <h3 className='title_h3'>{t('Employer.Manage_unions.Manage_union')}</h3>
                    <div className='search_box d-flex ms-auto'>
                        <div className='search_box_in'>
                            ...
                            <Form.Control type="email" placeholder={t('Employer.Manage_unions.Search')}/>
                        </div>
                        <Button
                            variant="outline-secondary"
                            onClick={() => setModalShow(true)}
                        >
                            0 {t('Employer.Manage_unions.Selected')}
                            <svg
                                width="17"
                                height="17"
                                viewBox="0 0 17 17"
                ...
                <Table className='custom_table' responsive>
                    <thead>
                        <tr>
                            <th width="50px"></th>
                            <th>{t('Employer.Manage_unions.Union_name')}</th>
                            <th>{t('Employer.Manage_unions.Production')}</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a href="#" onClick={() => navigate("/employer/updateUnion")}
                                className='link' >{t('Employer.Manage_unions.Edit')}</a> </td>
                        </tr>
                ...
                <div className="request-invite-archive mt-2">
                    <div className='d-flex'>
                        ...
                        2 {t('Employer.Manage_unions.Requests_pending')}
                        </Button>
                    ...
                    <Button className='btn-sm ms-2 ps-3 pe-3 ' variant="outline-secondary" onClick={() => navigate('/employer/unions-archive')}>
