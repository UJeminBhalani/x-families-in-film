  ...
  return (
    <>
      ...
      <div className='white_box manage_screen'>
        <div className='title_box d-inline-flex w100p'>
          ...
          <div className='search_box d-flex ms-auto'>
            <div className='search_box_in'>
              ...
              <Form.Control type="email" placeholder={t("Employer.Employee_requests_approval.Search")} />
            </div>
          </div>
        </div>
        <Table className='custom_table' responsive>
          <thead>
            <tr>
              ...
              <th>{t("Employer.Employee_requests_approval.Last_name")}</th>
              <th>{t("Employer.Employee_requests_approval.First_name")}</th>
          ...
          <tbody>
            <tr>
              ...
              <td>
                <div className="action_button">
                  <a  onClick={()=>setShowCancel(prev=>!prev)} className="link" style={{ color: "#DC6962" }}>
                    {t('Employer.Union_requests_approval.Cancel')}
                  </a>
                  <a onClick={()=>setShowResend(prev=>!prev)} className="link" style={{ color: "#038900" }}>
            ...
            <tr>
              <td><b>Muzan</b><span><img src={FamilyLogo} alt="" /></span></td>
              <td><b>Tanjiro</b></td>
              <td>Deadpool 2</td>
              <td>Vancouver Film <br />Studios</td>
        ...
        <Button variant="dark" className='round_btn' onClick={() => setShow(prev => !prev)}>
