...
import { archivelist } from "../Services/https/Admin/Admin";
...
const ArchivedEmployers = () => {
    ...
    useEffect(() => {
        archivelist(search, sort, 10, initialpage).then(response => { setList(response?.data?.data?.data); setLoader(false);setTotalcount(response?.data?.data?.total) }).catch(error => {
            return error
        })
                    ...
                    <div className="search_box d-flex ">
                        <div className="search_box_in me-3">
                            <svg
                                ...
                                onClick={() => { sethandleSearch(prev => !prev); setLoader(true) }}
                            >
                                <path
         ...
         Generate Invite
                ...
                <div className="request-invite-archive mt-2">
                    <div className='d-flex'>
                        ...
                        <Button className='btn-sm  ps-3 pe-3 ' variant="outline-secondary" onClick={() => navigate('/admin/employers')}>
